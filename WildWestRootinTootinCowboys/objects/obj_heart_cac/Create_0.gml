...
function kill()
{
	audio_stop_sound(sfx_heart_cac_break);
	audio_play_sound(sfx_heart_cac_break, 10, false, .6, 0, random_range(.9, 1.2));
	
	instance_create_layer(x, y - 40, "Instances", obj_heart_pickup);
	var corpse = instance_create_layer(x, y, "Instances", obj_heart_cac_dead);
