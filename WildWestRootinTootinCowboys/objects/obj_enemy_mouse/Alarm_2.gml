...
{	
	recoil_angle = 20;
	var bullet = instance_create_layer(x + (90 * cos(degtorad(move_direction))), y - 36 - (90 * sin(degtorad(move_direction))), "Instances", obj_enemy_bullet2);
	bullet.reset_angle(move_direction);
	audio_play_sound(sfx_gun_reliable, 50, false);
}
